...
const ProductFilterPage = () => {
    ...
    const renderIllustrationGrid = () => {
        ...
        return (
            <div
                className="absolute inset-0 grid grid-cols-10 grid-rows-10 z-0 pointer-events-none"
                style={{ opacity: 0.19 }} // Ajusta la opacidad según lo requieras
            >
                {gridItems}
            </div>
        );
    ...
    return (
        <div className="relative bg-white min-h-screen pb-16 overflow-hidden">
            ...
            <div className="bg-white/80 backdrop-blur-sm max-w-7xl mx-auto mt-10 px-4 rounded-2xl relative z-10">
                {/* Header */}
                <motion.div
                ...
                >
                    <div className="max-w-7xl mx-auto">
                        ...
                        <p className="text-primary-100 max-w-xl font-avenir">
