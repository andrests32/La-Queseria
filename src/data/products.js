...
export const products = [
    ...
    // Avícola (Poultry)
    {
      ...
      benefits: "Son una fuente rica en hierro, vitamina B12, vitamina A, vitamina D y ácido fólico, lo que ayuda a prevenir la anemia, fortalece el sistema inmunológico y contribuye a la salud en general.",
      vitamins: "El alto contenido de hierro y vitamina B12 ayuda a combatir y prevenir la anemia, condiciones que pueden causar fatiga y debilidad. También contienen fósforo, calcio, ácidos grasos omega-3 y antioxidantes.",
      category: "Avícola"
    },
    {
      id: "Carbohidrate-0",
    ...
    },
    {
      ...
      benefits: "El café ofrece varios beneficios para la salud, incluyendo mayor energía, mejor concentración, protección contra ciertas enfermedades y beneficios para la salud del hígado. También contiene antioxidantes.",
      vitamins: "Vitamina B2  Vitamina B3  Vitamina B5  Minerales:Calcio: Importante para la salud ósea y dental. Magnesio: Regula los niveles de azúcar en la sangre, el funcionamiento del sistema nervioso y la contracción muscular.",
      category: "Carbohidrato"
    },
    ...
    // Lácteos (Dairy)
    {
      ...
      vitamins: "El chorizo cervecero, es rico en proteínas, vitaminas del grupo B (tiamina, riboflavina, niacina, B6 y B12) y minerales como hierro, fósforo y zinc. Son un componente esencial en la dieta de muchas personas.",
      category: "Embutido"
    },
    {
      id: "especias-4",
